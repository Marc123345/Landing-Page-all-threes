...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    s1.onload = () => {
      ...
      s2.innerHTML = `window.jotformEmbedHandler("iframe[id='JotFormIFrame-261433248113449']", "https://form.jotform.com/")`;
        ...
        <div className="wrap" style={{ width: "100%" }}>
          <div className="hero-stack">
            ...
            <div className="form-embed">
              <iframe
                id="JotFormIFrame-261433248113449"
                title="Roof Coating Deal Request"
                onLoad={() => window.parent.scrollTo(0, 0)}
                allowTransparency={true}
                allow="geolocation; microphone; camera; fullscreen; payment"
                src="https://form.jotform.com/261433248113449"
                frameBorder={0}

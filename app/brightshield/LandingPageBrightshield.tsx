...
export default function LandingPageBrightshield() {
            ...
            <a href="#banner" className="logo" onClick={smoothScroll}>
              <span className="logo-mark" aria-hidden="true">
                <svg width="36" height="36" viewBox="0 0 40 40" fill="none">
                  <path d="M20 5 L34 11 L34 22 Q34 30 20 36 Q6 30 6 22 L6 11 Z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="miter" fill="none" />
                  <path d="M13 20 L18 25 L27 15" stroke="var(--primary)" strokeWidth="3" strokeLinecap="square" strokeLinejoin="miter" fill="none" />
                </svg>
              </span>
              <span className="logo-txt">Brightshield</span>
            </a>
          </div>
        </div>
      </header>
        ...
        <div className="footer-bottom">
          <div className="wrap">
            <div className="fb-inner">
              <p>© 2026 Brightshield. All Rights Reserved.</p>
            </div>
          </div>
        </div>
      </footer>

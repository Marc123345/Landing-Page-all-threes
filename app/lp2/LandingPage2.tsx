...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    s1.onload = () => {
      ...
      s2.innerHTML = `window.jotformEmbedHandler("iframe[id='JotFormIFrame-261433467251455']", "https://form.jotform.com/")`;
      ...
      <section id="banner" className="hero">
        ...
        <div className="wrap hero-grid">
          ...
          <div className="form-embed">
            <iframe
              id="JotFormIFrame-261433467251455"
              title="Roof Coating Deal Request"
              onLoad={() => window.parent.scrollTo(0, 0)}
              allowTransparency={true}
              allow="geolocation; microphone; camera; fullscreen; payment"
              src="https://form.jotform.com/261433467251455"
              frameBorder={0}
